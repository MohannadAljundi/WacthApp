...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback, LocationListener,GoogleMap.OnMarkerClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsers= FirebaseDatabase.getInstance().getReference("UserLocations");
