...
public class StudentHomeActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back_to_bus_profile2).setOnClickListener(this);
    ...
    private void setInitialLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( StudentHomeActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION )
                != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission( StudentHomeActivity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION )
                        != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        LocationServices.FusedLocationApi.requestLocationUpdates( googleApiClient, request, new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                StudentHomeActivity.this.latitude=lat;
                StudentHomeActivity.this.longitude=lng;
                ...
                try {
                    ...
                    LatLng positionUpdate = new LatLng( StudentHomeActivity.this.latitude,StudentHomeActivity.this.longitude );
                ...
                try {
                    geocoder = new Geocoder(StudentHomeActivity.this, Locale.ENGLISH);
    ...
    private void CheckMapPermission() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (ActivityCompat.checkSelfPermission( StudentHomeActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED &&
                    ActivityCompat.checkSelfPermission( StudentHomeActivity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION ) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions( StudentHomeActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 1002 );
            } else {
